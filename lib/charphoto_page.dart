...
class CharPhotoPage extends BaseVoicePage {
  final String characterType;
  const CharPhotoPage({Key? key, required this.characterType})
      : super(key: key);

  @override
  CharPhotoPageState createState() => CharPhotoPageState(characterType);
}

class CharPhotoPageState extends BaseVoicePageState {
  final String characterType;
  ...
  CharPhotoPageState(this.characterType);
  ...
  void initState() {
    ...
    print('charphoto initState called'); // Added a print statement here
...
class ControlButtons extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // print(
    //    'ControlButtons build called, isRecording: $isRecording'); // Added a print statement here
